  ...
  return (
    <>
      <div
       ...
       bg-[#121212]/70 text-white rounded shadow-xl transition-all duration-300 ${toggle
            ? "w-64 h-56 "
      ...
      {chart && <div className={`absolute top-24 right-4  py-2 backdrop-blur-md overflow-hidden
